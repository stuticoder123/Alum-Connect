...
const successStories = [
	{
		...
		story:
			"Through AlumConnect, I found a mentor who guided me through internship applications and technical interviews. Their insights into Google's hiring process were invaluable, and I'm now set to join the company after graduation.",
	...
	},
	{
		...
		story:
			"My startup idea needed industry expertise and connections. Through AlumConnect, I found alumni in the healthcare sector who became advisors and even early investors in my company. Their guidance helped me navigate regulatory challenges and refine my business model.",
	...
	},
	{
		...
		story:
			"I always dreamed of working internationally but had no connections abroad. An alumni working in London's financial district not only helped me understand the global job market but also referred me to his firm. His mentorship during the interview process was crucial to my success.",
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
				<motion.div
					...
					<p className="text-xl text-gray-600 max-w-3xl mx-auto">
						Real connections. Real impact. See how AlumConnect has helped shape
								...
								<div className="relative rounded-lg overflow-hidden shadow-xl">
									...
									<div className="absolute bottom-0 left-0 p-6">
										...
										<div className="flex items-center text-white text-sm">
											<span className="bg-teal-600 px-2 py-1 rounded">
				...
				<motion.div
					...
					<p className="text-lg text-gray-300 max-w-3xl mx-auto mb-6">
						Has AlumConnect helped you find a mentor, land a job, or make a
						valuable connection? We'd love to feature your story and inspire
						others.
					</p>

...
const testimonials: Testimonial[] = [
  {
    quote:
      "AlumConnect transformed my career journey completely. The mentorship I received was invaluable, and I'm now working at my dream company. The platform's matching system is incredibly accurate.",
    name: "Priya Sharma",
  ...
  {
    quote:
      "The platform made it incredibly easy to give back to my alma mater. Mentoring students has been one of the most rewarding experiences, and the tools make communication seamless.",
    name: "Rohit Patel",
  ...
  {
    quote:
      "The networking opportunities and events have opened doors I never thought possible. The community here is truly supportive and the connections are genuine and lasting.",
    name: "Ananya Desai",
    role: "Data Scientist",
    image:
  ...
  {
    quote:
      "Found my co-founder through AlumConnect! The platform's ability to connect like-minded individuals is exceptional. Our startup has raised $2M in funding with alumni support.",
    name: "Arjun Kumar",
    role: "Founder & CEO",
    image:
  ...
  {
    quote:
      "The career guidance and job referrals I received were game-changing. Within 3 months of joining, I had multiple offers from top-tier companies. Highly recommend!",
    name: "Sneha Gupta",
  ...
  {
    quote:
      "International career transition made easy! Alumni from different countries provided invaluable insights about global markets and helped me land my dream job abroad.",
    name: "Vikram Singh",
    role: "Consultant",
    image:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            See what our community members have to say about their transformative
            experience with AlumConnect
          </p>
        </motion.div>
